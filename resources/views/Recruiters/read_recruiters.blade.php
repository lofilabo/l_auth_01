...
<div class="main-container container-fluid">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col">
        <h1 class="text-primary mr-auto">RECRUITERS SEARCHING</h1>
      </div>
    </div>
  </div>
  <!-- /heading -->
      ...
      <tr class="data-row">
        <td class="align-middle iteration">{{$arrmember['id']}}</td>
          ...
          <td class="align-middle">
            <a type="button" class="btn btn-danger" href="/recruiters/del?id={{$arrmember['id']}}">del</a>  
            <button type="button" class="btn btn-success" id="edit-item" data-item-id="{{$arrmember['id']}}">edit</button></td>
      </tr>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="edit-modal-label">Recruiter Details</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body" id="attachment-body-content">
        <form id="edit-form" class="form-horizontal" method="POST" action="/recruiters/update?action={{$action}}">
          {{csrf_field()}}
