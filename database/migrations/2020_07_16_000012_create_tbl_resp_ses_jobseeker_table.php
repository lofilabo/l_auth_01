...
class CreateTblRespSesJobseekerTable extends Migration
{
    /**
     * Schema table name to migrate
     * @var string
     */
    public $tableName = 'tbl_resp_ses_jobseeker';

    /**
     * Run the migrations.
     * @table tbl_resp_ses_jobseeker
     *
     * @return void
     */
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->char('workarea', 255)->nullable()->default(null);
            $table->char('showcaseurl', 255)->nullable()->default(null);
