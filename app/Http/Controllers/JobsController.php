...
class JobsController extends Controller
{
    ...
    public function read_many(Request $request){
        ...
        switch ($action){
            case "idup":
                $arrCities = Jobs::where('status', "!=", "99")->orderBy('id', 'ASC')->get();
                break;
            case "iddown":
                $arrCities = Jobs::where('status', "!=", "99")->orderBy('id', 'DESC')->get();
                break;
            case "fnameup":
                $arrCities = Jobs::where('status', "!=", "99")->orderBy('fname', 'ASC')->get();
                break;
            case "fnamedown":
                $arrCities = Jobs::where('status', "!=", "99")->orderBy('fname', 'DESC')->get();
                break;
            case "lnameup":
                $arrCities = Jobs::where('status', "!=", "99")->orderBy('lname', 'ASC')->get();
                break;
            case "lnamedown":
                $arrCities = Jobs::where('status', "!=", "99")->orderBy('lname', 'DESC')->get();
                break;
            case "emailup":
                $arrCities = Jobs::where('status', "!=", "99")->orderBy('email', 'ASC')->get();
                break;
            case "emaildown":
                $arrCities = Jobs::where('status', "!=", "99")->orderBy('email', 'DESC')->get();
                break;
            case "telup":
                $arrCities = Jobs::where('status', "!=", "99")->orderBy('tel', 'ASC')->get();
                break;
            case "teldown":
                $arrCities = Jobs::where('status', "!=", "99")->orderBy('tel', 'DESC')->get();
                break;
            case "urlup":
                $arrCities = Jobs::where('status', "!=", "99")->orderBy('url', 'ASC')->get();
                break;
            case "urldown":
                $arrCities = Jobs::where('status', "!=", "99")->orderBy('url', 'DESC')->get();
                break;
            case "createtup":
                $arrCities = Jobs::where('status', "!=", "99")->orderBy('created_at', 'ASC')->get();
                break;
            case "createddown":
                $arrCities = Jobs::where('status', "!=", "99")->orderBy('created_at', 'DESC')->get();
                break;
            default:
                $arrCities = Jobs::where('status', "!=", "99")->get();
        }

        return view('Jobs.read_jobs', ["arr" => $arrCities->toArray(), "stat"=>$this->statuscodes, "action"=>$action]);
    }
